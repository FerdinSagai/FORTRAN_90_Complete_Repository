...
!=========================================================================================	
	...
	b(Nx/4,Ny/4,Nz/4)		= 100
	b(3*Nx/4,3*Ny/4,3*Nz/4)	= -100
!=========================================================================================	
!  Scheme
!=========================================================================================	
		...
		DO I = 2, Nx - 1
			DO J = 2, Ny - 1
				DO K = 2, Nz - 1
					...
					P(I,J,K,N_iter+1) = coeff * (X_Derivative + Y_Derivative + Z_Derivative - Source)
				END DO
			END DO
		END DO
	END DO
	...
	! WRITING OF RESULTS
	OPEN(100, FILE = "18.a.Poisson_equation_CS_Explicit.dat", FORM = "FORMATTED")
