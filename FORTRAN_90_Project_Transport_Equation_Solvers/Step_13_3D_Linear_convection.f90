...
!=========================================================================================	
	...
	DO  time_loop = 1, Nt
		DO I = 2, Nx - 1
			U(I,time_loop+1) = U(I,time_loop) - coefficient_convection*time_step/dx * (U(I,time_loop) - U(I-1,time_loop))
		END DO
		DO J = 2, Ny - 1
			V(J,time_loop+1) = V(J,time_loop) - coefficient_convection*time_step/dy * (V(J,time_loop) - V(J-1,time_loop))
		END DO	
		DO K = 2, Nz - 1
			W(K,time_loop+1) = W(K,time_loop) - coefficient_convection*time_step/dz * (W(K,time_loop) - W(K-1,time_loop))
		END DO	
	END DO
	! OUTPUT WRITING	
	OPEN(100, FILE = "13.a.Linear_Wave_3D_FTBS.dat", FORM = "FORMATTED")
